...
function LeaveApprovals() {
  ...
  const handleConfirmAction = async () => {
    ...
    try {
      ...
      setMsg({
        type: "success",
        text: `Leave ${actionModal.action} successfully`,
      });
    ...
    <div className="p-8 space-y-8">
      ...
      {actionModal.isOpen && actionModal.leave && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div
            className={`bg-[var(--bg-card)] rounded-lg shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in duration-200 border-t-4 ${
